...
class ProfileController extends Controller
{
    ...
    public function profileview(){
        ...
        return view('Admin.profile.profile',compact('seo','user'));
    }
    public function profilephotoupload(Request $request){
        ...
        if ($update) {
            return redirect('/admin/profile')->with('success', "Profile Photo Change Successfully");
        } else {
            return redirect('/admin/profile')->with('error', "Server Error");
        }
    }
    ...
    public function changepassword(){
        ...
        return view('Admin.profile.changepassword',compact('seo'));
    }
    public function changepasswordsubmit(Request $request){
        ...
        if ($update) {
            ...
            return redirect('/admin/changepasswordd')->with('error', "Server Error");
        }
    }
