...
class LeadsBillingController extends Controller
{
    public function leads(Request $request, $type)
    {
        try {
            ...
            return view('LeadCreator.bmystatus.mylist', compact('seo', 'leads','l_type','telecaller'));
        } catch (\Throwable $th) {
    ...
    public function leadedit($id)
    {
        try {
            ...
            return view('LeadCreator.bmystatus.edit',compact('seo','categorymaster','leads'));
    ...
    public function leadview($id)
    {
        try {
            ...
            return view('LeadCreator.bmystatus.view', compact('seo', 'leads', 'remarks'));
        } catch (\Throwable $th) {
            return redirect()->back()->with('error', "Server Error");
        }
    }
