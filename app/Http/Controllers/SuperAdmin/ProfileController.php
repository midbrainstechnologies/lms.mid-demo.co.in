...
class ProfileController extends Controller
{
    ...
    public function profileview(){
        ...
        return view('SuperAdmin.profile.profile',compact('seo','user'));
    }
    public function profilephotoupload(Request $request){
        ...
        if ($update) {
            return redirect('/super-admin/profile')->with('success', "Profile Photo Change Successfully");
        } else {
            return redirect('/super-admin/profile')->with('error', "Server Error");
        }
    }
    public function profileupdate(Request $request){
        ...
        if ($update) {
            return redirect('/super-admin/profile')->with('success', "Profile Updated Successfully");
        } else {
            return redirect('/super-admin/profile')->with('error', "Server Error");
        }
    }
    ...
    public function changepassword(){
        ...
        return view('SuperAdmin.profile.changepassword',compact('seo'));
    }
    public function changepasswordsubmit(Request $request){
        ...
        if ($update) {
            return redirect('/super-admin/changepassword')->with('success', "Password Change Successfully");
        } else {
            return redirect('/super-admin/changepasswordd')->with('error', "Server Error");
        }
    }
