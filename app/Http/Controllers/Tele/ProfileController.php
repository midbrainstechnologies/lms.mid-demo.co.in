...
class ProfileController extends Controller
{
    public function profileview(){
        ...
        return view('Tele.profile.profile',compact('seo','user'));
    }
    public function profilephotoupload(Request $request){
        ...
        if ($update) {
            return redirect('/tele-caller/profile')->with('success', "Profile Photo Change Successfully");
        } else {
            return redirect('/tele-caller/profile')->with('error', "Server Error");
        }
    }
    public function profileupdate(Request $request){
        ...
        if ($update) {
            return redirect('/tele-caller/profile')->with('success', "Profile Updated Successfully");
        } else {
            return redirect('/tele-caller/profile')->with('error', "Server Error");
        }
    }
    ...
    public function changepassword(){
        ...
        return view('Tele.profile.changepassword',compact('seo'));
    }
    public function changepasswordsubmit(Request $request){
        ...
        if ($update) {
            return redirect('/tele-caller/changepassword')->with('success', "Password Change Successfully");
        } else {
            return redirect('/tele-caller/changepasswordd')->with('error', "Server Error");
        }
    }
}
