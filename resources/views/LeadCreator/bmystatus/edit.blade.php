                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input  type="text" name="age" class="form-control"
                                            id="age" value="{{$leads['age']}}" placeholder="Enter Age" >

                                    </div>

                                    <div class="form-group">
                                        <label for="is_married">Married</label>
                                        <select   name="is_married" class="form-control" id="is_married"   >
                                            <option value="" >Select Option</option>
                                            <option <?=(!empty($leads))?(($leads['is_married']=="1")?' selected ':''):''?> value="1" >Yes</option>
                                            <option <?=(!empty($leads))?(($leads['is_married']=="0")?' selected ':''):''?> value="0" >No</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="is_xerox">Xerox of medical records of past 6 months if any:</label>
                                        <select   name="is_xerox" class="form-control" id="is_xerox"   >
                                            <option value="" >Select Option</option>
                                            <option <?=(!empty($leads))?(($leads['is_xerox']=="1")?' selected ':''):''?> value="1" >Yes</option>
                                            <option <?=(!empty($leads))?(($leads['is_xerox']=="0")?' selected ':''):''?> value="0" >No</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input  type="text" name="occupation" class="form-control"
                                            id="occupation" value="{{$leads['occupation']}}" placeholder="Enter Occupation" >

                                    </div>
                                    <div class="form-group">
                                        <label for="come_from">Awareness about us through:</label>
                                        <input  type="text" name="come_from" class="form-control"
                                            id="come_from" value="{{$leads['come_from']}}" placeholder="Awareness about us through." >

                                    </div>

                                    <div class="form-group">
                                        <label for="problem">Symptoms / Disease</label>
                                        <textarea name="problem" class="form-control"
                                            id="problem"   placeholder="Enter Symptoms / Disease" >{{$leads['problem']}}</textarea>

                                    </div>


                                    <div class="form-group">
                                        <label for="problem_detail">What is the Hair problem? How long? Reason for problem? Any treatment taken before?</label>
                                        <textarea name="problem_detail" class="form-control"
                                            id="problem_detail"   placeholder="What is the Hair problem? How long? Reason for problem? Any treatment taken before?" >{{$leads['problem_detail']}}</textarea>

                                    </div>
                                    <div class="form-group">
                                        <label for="addr">Enter Address</label>
                                        <textarea name="addr" class="form-control"
                                            id="addr"   placeholder="Enter Address" >{{$leads['addr']}}</textarea>
