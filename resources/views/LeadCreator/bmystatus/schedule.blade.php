                                ...
                                <tr class="{{$bg}}">
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a href="{{url('/admin/mylead/detail/'.Crypt::encrypt($list['id'])).'?update=remark'}}" type="button" class="btn btn-outline-success"><i class="fa fa-eye"></i></a>
                                            <a href="{{url('/admin/mylead/editform/'.Crypt::encrypt($list['id']))}}" type="button" class="btn btn-outline-primary"><i class="fa fa-edit"></i></a>
  ...
  <div class="modal fade" id="deletemdl" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md modal-dialog-scrollable">
        <div class="modal-content">
            <form method="POST" action="{{ asset('/admin/schedule/delete') }}">
                @csrf
